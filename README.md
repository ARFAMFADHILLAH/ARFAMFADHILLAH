...
### 🚀 About Me
> **Mobile Developer** with a strong focus on **Native Android (Kotlin / Jetpack Compose)** and **Cross-Platform (Flutter)** development. Passionate about building clean mobile architectures, smooth UI/UX, and integrating robust backend APIs.

* 📱 **Core Focus:** Native Android, Flutter, Mobile Security & CI/CD
* 🛠️ **Preferred IDEs:** Android Studio, VS Code, Neovim
* 🎓 **Currently Exploring:** Kotlin Multiplatform (KMP) & Advanced Jetpack Compose
